...
Two middleware functions are provided by default in the `luminus-upload-files.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `luminus-upload-files.handler` namespace to manage the enabled middleware.
